...
template <typename T> //genericos de java
class aStack
{
  private:
  ...
  public:
    ...
    void push(T &v)
    {
      ...
      if(cur_size==max_size){// nao acrescentar memoria grao a grao, puxa muito pelo sistema
          T*t_data=data;
          max_size+=100;
          data=new T[max_size+100];
          memccpy(data,t_data,cur_size*sizeof(T))
          delete t_data;
